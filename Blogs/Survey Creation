...
Last week, we started creating our user testing questionnaire. We first reviewed our notes from the User Interface Design and Implementation module for guidance and noted down the most important points. We prioritised usability and UX goals, made sure each question measured something meaningful, and related the questions to real tasks the users would perform.

Our primary usability goals were:

1. Efficiency – users should be able to quickly search, scan, and compare food
2. Error rate – AI estimates and meal scans must feel reliable
3. Learnability – first-time users should understand features with minimal instruction
4. Satisfaction – users feel the app is helpful and worth returning to

Our UX goals were: 
Trust and confidence, motivation, enjoyment and clarity
...
4. Do you think the search results and health scores are informative enough? Why or why not?
