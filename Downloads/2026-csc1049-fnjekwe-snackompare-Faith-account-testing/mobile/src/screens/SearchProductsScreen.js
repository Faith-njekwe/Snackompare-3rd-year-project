...
export default function SearchProductsScreen({ navigation, route }) {
  const fromCalorieTracker = route.params?.fromCalorieTracker === true;
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              {fromCalorieTracker && (
                <TouchableOpacity
                  style={styles.addTrackerBtn}
                  onPress={() =>
                    navigation.navigate("CalorieMain", {
                      product: {
                        name: item.name,
                ...
                >
                  ...
                  <Text style={styles.addTrackerBtnText}>Add</Text>
                </TouchableOpacity>
              )}
              {!fromCalorieTracker && (
                <View
